...
param azureMonitorPrivateLinkScopeName = readEnvironmentVariable('AZURE_MONITOR_PRIVATE_LINK_SCOPE_NAME', 'ampls-nprd-hub-uks-001')
...
param logicAppServicePlanName = readEnvironmentVariable('LOGIC_APP_SERVICE_PLAN_NAME', '')
...
param useExistingDnsZones = bool(readEnvironmentVariable('USE_EXISTING_DNS_ZONES', 'false'))
param createExistingDnsZoneVnetLinks = bool(readEnvironmentVariable('CREATE_EXISTING_DNS_ZONE_VNET_LINKS', 'false'))
...
param createApplicationInsights = bool(readEnvironmentVariable('CREATE_APPLICATION_INSIGHTS', 'true'))
