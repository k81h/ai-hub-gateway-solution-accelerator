...
resource hostingPlan 'Microsoft.Web/serverfarms@2024-04-01' = {
  name: !empty(servicePlanName) ? servicePlanName : 'hosting-plan-${logicAppName}'
  tags: union(tags, { 'azd-service-name': !empty(servicePlanName) ? servicePlanName : 'hosting-plan-${logicAppName}' })
  location: location
  sku: {
    name: skuName //'WS1'
