...
param apimSubnetPrefix = readEnvironmentVariable('APIM_SUBNET_PREFIX', '10.168.14.128/26')
param privateEndpointSubnetPrefix = readEnvironmentVariable('PRIVATE_ENDPOINT_SUBNET_PREFIX', '10.168.14.0/26')
param functionAppSubnetPrefix = readEnvironmentVariable('FUNCTION_APP_SUBNET_PREFIX', '10.168.15.128/26')
param agentSubnetPrefix = readEnvironmentVariable('AGENT_SUBNET_PREFIX', '10.168.15.0/26')

// DNS Zone parameters (legacy approach - single subscription/RG)
param useExistingDnsZones = bool(readEnvironmentVariable('USE_EXISTING_DNS_ZONES', 'true'))
param createExistingDnsZoneVnetLinks = bool(readEnvironmentVariable('CREATE_EXISTING_DNS_ZONE_VNET_LINKS', 'true'))
...
param createApplicationInsights = bool(readEnvironmentVariable('CREATE_APPLICATION_INSIGHTS', 'false'))
...
param logicAppsSkuCapacityUnits = int(readEnvironmentVariable('LOGIC_APPS_SKU_CAPACITY_UNITS', '2'))
